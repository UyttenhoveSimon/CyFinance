...
public class LiveYahooApiIntegrationTests
{
    ...
    [Test]
    public Task QuoteSummaryService_GetQuoteSummaryAsync_ReturnsLiveSummary()
    {
        ...
        return LiveYahoo.RunAsync(nameof(QuoteSummaryService_GetQuoteSummaryAsync_ReturnsLiveSummary), async () =>
        {
    ...
    [Test]
    public Task HistoricalDataService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(HistoricalDataService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task CryptoService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(CryptoService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task CurrencyService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(CurrencyService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task SearchService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(SearchService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task EarningsCalendarService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(EarningsCalendarService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "AAPL";
    ...
    [Test]
    public Task OptionsDataService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(OptionsDataService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task AnalystRecommendationsService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(AnalystRecommendationsService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "AAPL";
    ...
    [Test]
    public Task FinancialStatementsService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(FinancialStatementsService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "AAPL";
    ...
    [Test]
    public Task FundDataService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(FundDataService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "VOO";
    ...
    [Test]
    public Task CompanyNewsService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(CompanyNewsService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "AAPL";
    ...
    [Test]
    public Task SectorIndustryService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(SectorIndustryService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task MarketSummaryService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(MarketSummaryService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task GlobalCalendarsService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(GlobalCalendarsService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
    ...
    [Test]
    public Task ShareholderInformationService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(ShareholderInformationService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
            var ticker = "AAPL";
    ...
    [Test]
    public Task StockScreeningService_EndToEndMethods_WorkAgainstYahoo()
    {
        if (!RunLiveYahooTests)
        {
            return Task.CompletedTask;
        ...
        return LiveYahoo.RunAsync(nameof(StockScreeningService_EndToEndMethods_WorkAgainstYahoo), async () =>
        {
