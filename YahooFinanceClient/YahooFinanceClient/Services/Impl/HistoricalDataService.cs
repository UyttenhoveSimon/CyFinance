...
namespace YahooFinanceClient.Chart
{
    public class HistoricalDataService
    {
        ...
        public static async Task<ChartResponse> GetHistoricalDataAsync(
            string ticker,
            ...
            bool includeSplits = true)
        {
            try
            {
                ...
                return await _httpClient.GetFromJsonAsync<ChartResponse>(url, _jsonOptions);
            }
            catch (Exception ex)
            {
        ...
        public static async Task<List<HistoricalPrice>> GetHistoricalPricesAsync(
            string ticker,
            DateTime? startDate = null,
            DateTime? endDate = null,
            ChartInterval interval = ChartInterval.OneDay,
        ...
        private static List<HistoricalPrice> ConvertToHistoricalPrices(ChartResponse chartResponse)
        {
        ...
        public static List<DividendInfo> GetDividends(ChartResponse chartResponse)
        {
        ...
        public static List<SplitInfo> GetSplits(ChartResponse chartResponse)
        {
